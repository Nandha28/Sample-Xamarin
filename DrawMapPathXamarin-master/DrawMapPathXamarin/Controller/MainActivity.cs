...
namespace DrawMapPathXamarin
{
	...
	public class MainActivity : Activity
	{
		...
		{ 
			...
			string strLocation = "Guindy,chennai";
			...
			{ 
				...
				var Position= new LatLng ( objGeoCodeJSONClass.results [0].geometry.location.lat , objGeoCodeJSONClass.results [0].geometry.location.lng );
			} 
